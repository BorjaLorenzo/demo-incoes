...
<div class="container">
    <div class="row row-cols-4 mt-5  justify-content-center">
        <div class="col d-flex flex-column align-items-center dash-icon-hover " id=""><div class="a-click" id="personal">{{ svg('healthicons-o-construction-worker') }}</div><span>Personal</span></div>
