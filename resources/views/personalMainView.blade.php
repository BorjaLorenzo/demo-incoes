...
@section('content')
    ...
    <div class="container">
        <div class="row">
            <div class="col">Trabajadores </div>
        </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <button type="button" class="btn btn-primary editmodal" data-toggle="modal"
                                    data-target="#editarModal"><i class="bi bi-pencil-square"></i></button>
                                ...
                                <button type="button" class="btn btn-danger deletealert" data-toggle="modal"
                                    data-target="#eliminarModal"><svg xmlns="http://www.w3.org/2000/svg" width="16"
